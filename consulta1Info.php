<?php
    ...
    WHERE curso = 'ETIM INFOWEB' AND serie = '1º Ano'";
...
<body>
    <div>
        <center>
            <h1 class="titulo"><b>Consulta de Dados - ETIM INFOWEB - 1º Ano<b></h1>
        </center>
    </div>
    <div>
        <div class="btn-group">
        ...
        <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="consultaInfo.php">Consulta Infoweb</a>
    </div>
    </div>
